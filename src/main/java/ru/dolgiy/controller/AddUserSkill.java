 ...
 */
public class AddUserSkill extends HttpServlet {
    protected void doPost (HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException {
        RequestDispatcher rd = null;
        int a = Integer.parseInt(request.getParameter("userID"));
        int b = Integer.parseInt(request.getParameter("tech2add"));
        String name = request.getParameter("userName");
        String surname= request.getParameter("userSurname");
        try {
            UserKnowledgeManagement.getInstance().addUserSkill(a,b);
    ...
    protected void doGet (HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException {
        RequestDispatcher rd = null;
        if(request.getParameter("tech2add")!=null){
        int a = Integer.parseInt(request.getParameter("userID"));
        int b = Integer.parseInt(request.getParameter("tech2add"));
        String name = request.getParameter("userName");
        String surname= request.getParameter("userSurname");
        ...
        else {rd =request.getRequestDispatcher("/GetUsersTechByID");
            rd.forward(request,response);}
    }
}
